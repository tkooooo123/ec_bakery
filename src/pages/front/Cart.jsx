...
const Cart = memo(function Cart() {
    ...
    const { cartData, getCart, checkTokenIsValid } = useOutletContext();
                                                        ...
                                                        <div className="item-quantity mt-3 ">
                                                            <div className="input-group align-items-center" style={{ width: '80px' }}>
                                                                <select className="form-select" id=""
                                                                    value={item.cartProducts.quantity > item.cartProducts.CartItem.quantity ? item.cartProducts.CartItem.quantity : item.cartProducts.quantity}
